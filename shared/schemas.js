...
import { z } from 'zod';
import { ROLES, ITEM_MOVEMENT_TYPES, HALLMARK_STATUSES, PAYMENT_MODES, LEAD_STATUSES, ORDER_STATUSES, PAYMENT_STATUSES, PURITY_VALUES, PURCHASE_ORDER_STATUSES, GOLD_LOAN_STATUSES, } from './constants.js';
// --- Primitives ---
...
export const PuritySchema = z.union(PURITY_VALUES.map((v) => z.literal(v)));
